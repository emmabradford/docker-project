...
#source: https://dev.to/importox/how-to-write-in-an-existing-file-in-python-af4
#write to results
r = open("./home/output/result.txt", "w")
r.write("file names in /home/data")
r.write(entry[0])
r.write(entry[1])
r.write("number of words in if.txt")
r.write(str(numWordsInIF))
r.write("number of words in limerick.txt")
r.write(str(numWordsInLim))
r.write("total words in both files")
r.write(str(totalWords))
r.write("Most common word")
r.write(wordAndFrequency[0][0])
r.write("frequency of word")
r.write(str(wordAndFrequency[0][1]))
r.write("second most common word")
r.write(wordAndFrequency[1][0])
r.write("frequency of word")
r.write(str(wordAndFrequency[1][1]))
r.write("Third most common word")
r.write(wordAndFrequency[2][0])
r.write("frequency of word")
r.write(str(wordAndFrequency[2][1]))
r.write("Ip address of computer")   
r.write(IPAddr)